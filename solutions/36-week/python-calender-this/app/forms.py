...
from wtforms.fields import (
    BooleanField, DateField, StringField, SubmitField, TextAreaField, TimeField, DateTimeLocalField
)
...
v = [DataRequired()]
di = {'default': datetime.now}
sti = {'default': next_block()}
eti = {'default': next_block(60)}
