...
In this practice you will create a function component and pass props from a
...
Create a function component called `BaseStats` in your __src__ folder. It
...
In the argument for the `BaseStats` function component, destructure the
